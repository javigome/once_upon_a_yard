...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _showSpotPreview(BuildContext context, HarvestSpot spot) async {
    Map<String, dynamic>? gardenInfo = await _firestoreService.getGardenDetails(
      spot.gardenId,
    );
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  crossAxisAlignment:
                      CrossAxisAlignment.start, // Align top so button stays up
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              // 2. ALSO WRAP LONG TEXT INSIDE NESTED ROWS
                              Flexible(
                                child: Text(
                          ...
                          // THIS WILL NOW WRAP AUTOMATICALLY
                          Text(
                            '${gardenInfo?['name']} - ${gardenInfo?['description']}',
                            softWrap: true,
                          ),
                          const SizedBox(height: 20),
                          const Text(
                          ...
                          Text("Available ${spot.category}"),
                        ],
                      ),
                    ),

                    // The button stays on the right
                    const SizedBox(width: 10), // Add some breathing room
                    ElevatedButton(
                      onPressed: () {
                        /* ... */
                      },
